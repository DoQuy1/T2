...
' trang hien tai
    ...
    if(trim(inputsearch) <> "") or (NOT IsNull(inputsearch)) or trim(optionsearch) <> "" or (NOT IsNull(optionsearch)) then
      ...
      Case 2
      strSQL = "SELECT COUNT(ProductID) AS count FROM Products Where CategoryID=(Select CategoryID From Category where CategoryName Like '%"&inputsearch&"%') "
      Case 3
...
' lay ve tong so trang
    ...
    currentUrl = "searchProduct.asp?input-search="&inputsearch&"&option-search="&optionsearch&"&"
%>
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    Select Case optionsearch
                                      ...
                                      Case 2
                                      cmdPrep.CommandText = "SELECT * FROM Products Where CategoryID=(Select CategoryID From Category where CategoryName Like '%"&inputsearch&"%') ORDER BY ProductID OFFSET ? ROWS FETCH NEXT ? ROWS ONLY"
                                      Case 3
