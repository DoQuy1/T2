              ...
              <form action="removecart.asp" method=post id ="myForm">
                        ...
                        <table class="table shoping-cart-table">
                            ...
                            <tr>
                                <td class="align-middle" width="5">
                                  <input type="checkbox" name="cb-selector" value="<%=rs("ProductID")%>" data-totalprice="<%=rs("Price")*mycarts.Item(CStr(rs("ProductID")))%>">
                                </td>
                                <td width="90">
                ...
                %> 
                 ...
                 <div class="ibox-content">
                    ...
                    <input type="submit" name="checkout" value="Checkout" class="btn btn-primary btn-md pull-right mr-2  <%= statusButtons %>"></input>
